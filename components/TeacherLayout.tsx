...
import { Home, Book, ClipboardList, LogOut, Menu, X, Briefcase, Clock, Video } from 'lucide-react';
    ...
    <div className="flex h-screen bg-secondary dark:bg-gray-900 overflow-hidden transition-colors duration-200">
      ...
      `}>
        ...
        <nav className="flex-grow space-y-2 px-4 overflow-y-auto">
          <NavLink to="/teacher/dashboard" className={getNavLinkClass} onClick={() => setIsSidebarOpen(false)}>
            <Home className="mr-3 h-5 w-5" />
            Dashboard
          </NavLink>
          <NavLink to="/teacher/notes" className={getNavLinkClass} onClick={() => setIsSidebarOpen(false)}>
          ...
          <NavLink to="/teacher/live" className={getNavLinkClass} onClick={() => setIsSidebarOpen(false)}>
           ...
           <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3 overflow-hidden">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 truncate">Teacher</p>
                    </div>
                </div>
           </div>
          <button
          ...
          <header className="bg-white dark:bg-gray-800 p-4 shadow-sm flex items-center justify-between md:hidden z-10 shrink-0 transition-colors duration-200">
              <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-xl font-bold text-primary font-poppins">Teacher</span>
                  </div>
              </div>
          </header>
